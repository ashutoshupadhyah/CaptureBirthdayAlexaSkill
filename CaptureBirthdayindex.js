...
const persistenceAdapter = require("ask-sdk-s3-persistence-adapter": "^2.0.0");
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        const repromptText = 'I was born on June 26th 1999. When were you born?';
...
const CaptureBirthdayIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'Thanks, I will remember that you were born ${month} ${day} ${year}.';
        return handlerInput.responseBuilder
            .speak(speakOutput)
